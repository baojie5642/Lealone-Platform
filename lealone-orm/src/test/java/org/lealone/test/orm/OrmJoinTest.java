...
import org.lealone.test.OrmSqlScript;
...
public class OrmJoinTest extends UnitTestBase {
    ...
    @Override
    public void test() {
        OrmSqlScript.createCustomerTable(this);
        OrmSqlScript.createCustomerAddressTable(this);
        OrmSqlScript.createProductTable(this);
        OrmSqlScript.createOrderTable(this);
        OrmSqlScript.createOrderItemTable(this);
